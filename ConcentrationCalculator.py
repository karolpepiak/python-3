...
while app_running is True:
    ...
    print("[1] Percentage concentration")
    print("[2] Molar concentration")

    while temp_bool is True:
        try:
            user_choise = int(input())
            if user_choise != 1 and user_choise != 2:
                print("Type 1 or 2")
            else:
                temp_bool = False
        except:
    ...
    if user_choise == 1:
        ...
        print("The percentage concentration of " + str(substance_mass) + "g of substance dissolved in " + str(solvent_mass) + "g of solvent is: " + str(result) + "%.")
        ...
        print("The molar concentration of " + str(substance_mass) + "g of substance with molar mass equal to " + str(molar_mass) + "g/mol dissolved in " + str(volume) + "dm3 of solvent is: " + str(result) + "mol/dm3.")
